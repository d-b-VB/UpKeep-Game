...
const structureUpkeep = {
  ...
  palace: { supplies: 1, crafts: 1, luxury: 1, support: 1, authority: 1, wood: 1, livestock: 1, crops: 1 },
  outpost: { supplies: 1 },
  stronghold: { crafts: 1 },
  keep: { luxury: 1 },
};
...
endTurnBtn.addEventListener('click', () => {
  ...
  revealExpandingTiles();
  selectedKey = null;
  lastDebug = 'Turn advanced. Top economy strip reflects continuous produced/used/available flow.';
  render(logs);
  renderAiTurnIndicator(null, []);
  syncOnlineStateIfHost();
});
...
function initInstructionDiagrams() {
  const upkeepInfo = {
    ...
    palace: 'Upkeep: 1 village, 1 town, 1 city, 1 manor, 1 estate output plus 1 wood, 1 livestock, 1 crops.',
